			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<table class="table table-bordered table-striped" id="tableSort">
						<thead>
							<tr>
								<th><input type="checkbox" name="ids" value="" id="check01"
									onclick="checkAll()" /></th>
								<th onclick="$.sortTable.sort('tableSort',0)">ID</th>
								<th>考生类型</th>
								<th onclick="$.sortTable.sort('tableSort',1)">考生编号</th>
								<th>学院代码</th>
								<th>学院名称</th>
								<th>专业代码</th>
								<th>专业名称</th>
								...
								<th>专业课一</th>
								<th>专业课二</th>
								<th onclick="$.sortTable.sort('tableSort',2)">初试成绩</th>
								<th>笔试成绩</th>
								<th>面试成绩</th>
								<th>口语成绩</th>
								<th>复试成绩</th>
						...
						<tbody>
							<c:forEach items="${scoreList}" var="score">
								<tr>
									...
									<td>${score.bs}</td>
									<td>${score.ms}</td>
									<td><input type="text" name="kys" value="${score.ky}"></input></td>
									<td>${score.fs}</td>
